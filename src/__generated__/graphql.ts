...
export type GetAppointmentsQuery = { __typename?: 'Query', getAppointments: Array<{ __typename?: 'Appointment', id: string, time: string, doctor: { __typename?: 'Doctor', name: string, speciality: { __typename?: 'Speciality', name: string } } }> };
